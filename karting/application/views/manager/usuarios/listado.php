            ...
            <table class="table table-bordered table-striped">
              <thead>                
                <tr>                  
                  ...
                  <th>Rut                     
                      <?php create_link_orden('rut',$base_path,$comienzo,$cuantos,$busqueda) ?>
                  </th>
                  <th>Correo                     
                      <?php create_link_orden('correo',$base_path,$comienzo,$cuantos,$busqueda) ?>
                  </th> 
                  <th>Teléfono                     
                      <?php create_link_orden('telefono',$base_path,$comienzo,$cuantos,$busqueda) ?>
                  </th>   
                  <th>Acciones</th>
              ...
              <tbody>
                ...
                <tr>                  
                  ...
                  <td> <?php echo format_rut($registros[$i]->rut);?>  </td>              
                  <td> <?php echo $registros[$i]->correo;?>  </td>              
                  <td> <?php echo $registros[$i]->telefono;?>  </td>              
                  
                  <td>      
                    
                    <a class="btn btn-success btn-responsive" href="<?php echo $base_path;?>/editar/<?php echo $registros[$i]->id_usuario;?>">
                      <i class="fa fa-edit"></i> Editar
                    </a>
                    <!-- Ir a vueltas -->
                    <form method="POST" class="form-inline" style="display: inline;" action="<?php echo site_url('managervueltas/listado/0/10/id-desc/');?>" >
                      <input type="hidden" name="busqueda" class="form-control input-largo" placeholder="Ingrese el texto a buscar" value="<?php echo trim($registros[$i]->nombre); ?> ">
                      <button type="submit" class="btn btn-success btn-responsive"><i class="fa fa-clock-o"></i> Vueltas</button>
                    </form>
                    <!--<a class="btn btn-danger btn-responsive triger-modal" href="#deleteModal" data-id="<?php //echo $registros[$i]->id_usuario;?>" data-toggle="modal">
