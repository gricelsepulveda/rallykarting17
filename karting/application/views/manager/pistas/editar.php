...
<div class="content">
    ...
    <small>* Campo obligatorio</small>
        ...
        <div class="row">
            <div class="col-md-9">
                <form id="frmEditarUsuario" method="POST" action="<?php echo $base_path;?>/actualizar/<?php echo $data->id_pista;?>" >
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" value="<?php echo $data->descripcion; ?>" class="form-control" minlength="4" required name="descripcion">
                    </div> 
