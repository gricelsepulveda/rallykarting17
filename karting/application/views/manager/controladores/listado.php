              ...
              <tbody>
                ...
                <tr>                  
                  ...
                  <td>      
                    ...
                    <a class="btn btn-success btn-responsive" href="<?php echo $base_path;?>/editar/<?php echo $registros[$i]->id_controlador;?>">
                      <i class="fa fa-edit"></i> Editar
                    </a> 
                    <a class="btn btn-danger btn-responsive triger-modal" href="#deleteModal" data-id="<?php echo $registros[$i]->id_controlador;?>" data-toggle="modal">
