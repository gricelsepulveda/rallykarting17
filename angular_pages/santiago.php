...
<script src="js/galeria/santiago.js" type="text/javascript"></script><!--GALERIA FACEBOOK JS-->
					<div class="contenedor_sede">
						...
						<article class="seccion_indicaciones">
							<div class="lateral_left img_left"
								style="
									background: #000000 url(img/santiago/mapa.png);
								...
								"
							><!--MAPA-->
								<a target="_blank" href="https://goo.gl/maps/QWcxsj9LbJm">
									<figure>
										<img src="img/santiago/mapa.png"><!--MAPA GOOGLE MAPS-->	
									</figure>
								</a>
							</div>
							<div class="lateral_right"><!--INDICACIONES MAPA-->
								<div class="indicaciones">
									...
									<span>Lunes a viernes 11:00 a 21:30hrs. Sábado y domingo 11:00 a 22:00hrs</span>
									<br/>
									<p>Dirección <i class="fa fa-angle-left"></i></p>
									<span>Avenida Concha y toro 1477, Puente Alto</span>
									<br/>
									<p>E-mail <i class="fa fa-angle-left"></i></p>
									<span>santiago@rallykarting.cl</span>
									<br/>
									<p>Teléfonos <i class="fa fa-angle-left"></i></p>
									<a href="+56949423527‬"><span>+56 9 49423527‬</span></a>
									<br/>
						...
						<article class="seccion_novedades">
							<div class="lateral_left img_left"
								style="
                                	background: #F5DA81 url(http://graph.facebook.com/499708476821062/picture?width=3000);
                                ...
                                <!--IMAGEN NOTICIA-->
                                <figure>
									<a target="_blank" href="https://www.facebook.com/Rally-Karting-Puente-Alto-499708476821062">
                                    <img src="http://graph.facebook.com/499708476821062/picture?width=3000">
									</a>	
								</figure>
                                <!--FIN IMAGEN NOTICIA-->
							</div>
							<div class="lateral_right"><!--INDICACIONES MAPA-->
								...
								$tl = new timeline (
    							 '499708476821062', // username or id
								...
								<a target="_blank" href="https://www.facebook.com/Rally-Karting-Puente-Alto-499708476821062"><span class="btn_social">Visitar fanpage</span></a>
							</div>
						</article>
