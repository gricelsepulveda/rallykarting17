...
<script src="js/galeria/vinadelmar.js" type="text/javascript"></script><!--GALERIA FACEBOOK JS-->
					<div class="contenedor_sede">
						...
						<article class="seccion_indicaciones">
							<div class="lateral_left img_left"
								style="
									background: #000000 url(img/vina_del_mar/mapa.png);
								...
								"
							><!--MAPA-->
								<a target="_blank" href="https://www.google.cl/maps/place/Calle+Valpara%C3%ADso+1040,+Vi%C3%B1a+del+Mar,+Regi%C3%B3n+de+Valpara%C3%ADso/@-33.0261613,-71.5489829,17z/data=!4m5!3m4!1s0x9689de7530229ce3:0xa4cd047047998110!8m2!3d-33.0256981!4d-71.5476633">
									<figure>
										<img src="img/vina_del_mar/mapa.png"><!--MAPA GOOGLE MAPS-->	
									</figure>
								</a>
							</div>
							<div class="lateral_right"><!--INDICACIONES MAPA-->
								<div class="indicaciones">
									...
									<span>Lunes a Jueves 10:00 a 21:00hrs. Viernes y Sábado 10:00 a 21:30hrs. Domingo 10:00 a 21:00hrs</span>
									<br/>
									<p>Dirección <i class="fa fa-angle-left"></i></p>
									<span>V Region, Viña del mar – Avenida valparaíso #1070, mall espacio urbano viña centro 5to piso.</span>
									<br/>
									<p>E-mail <i class="fa fa-angle-left"></i></p>
									<span>a@Rallykarting.cl</span>
									<br/>
									<p>Teléfonos <i class="fa fa-angle-left"></i></p>
									<a href="+56996986543"><span>+56 9 96986543</span></a>
									<a href="+56967768272"><span>+56 9 67768272</span></a>
									<br/>
						...
						<article class="seccion_novedades">
							<div class="lateral_left img_left"
								style="
                                	background: #F5DA81 url(http://graph.facebook.com/1623296331276840/picture?width=3000);
                                ...
                                <!--IMAGEN NOTICIA-->
                                <figure>
									<a target="_blank" href="https://www.facebook.com/Rally-Karting-Viña-1623296331276840/">
                                    <img src="http://graph.facebook.com/1623296331276840/picture?width=3000">	
									</a>	
								</figure>
                                <!--FIN IMAGEN NOTICIA-->
							</div>
							<div class="lateral_right"><!--INDICACIONES MAPA-->
                                ...
                                <?php
								$tl = new timeline (
    							 '1623296331276840', // username or id
								...
								<a target="_blank" href="https://www.facebook.com/Rally-Karting-Viña-1623296331276840/"><span class="btn_social">Visitar fanpage</span></a>
							</div>
						</article>
