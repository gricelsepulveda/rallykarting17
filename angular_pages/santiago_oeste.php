...
<script src="js/galeria/santiago_oeste.js" type="text/javascript"></script><!--GALERIA FACEBOOK JS-->
					<div class="contenedor_sede">
						...
						<article class="seccion_indicaciones">
							<div class="lateral_left img_left"
								style="
									background: #000000 url(img/santiago_oeste/mapa.jpg);
								...
								"
							><!--MAPA-->
								<a target="_blank" href="https://goo.gl/maps/SEDY8wo5X822">
									<figure>
										<img src="img/santiago_oeste/mapa.jpg"><!--MAPA GOOGLE MAPS-->	
									</figure>
								</a>
							</div>
							<div class="lateral_right"><!--INDICACIONES MAPA-->
								<div class="indicaciones">
									...
									<span>Lunes a Domingo de 11:00 a 22:00hrs</span>
									<br/>
									<p>Dirección <i class="fa fa-angle-left"></i></p>
									<span>Avenida Americo Vespucio 2901, Cerrillos</span>
									<br/>
									<p>E-mail <i class="fa fa-angle-left"></i></p>
									<span>oeste@rallykarting.cl</span>
									<br/>
									<p>Teléfonos <i class="fa fa-angle-left"></i></p>
									<a href="+56945736763‬"><span>+56 9 45736763</span></a>
									<br/>
									<p>Valores <i class="fa fa-angle-left"></i></p>
									<span>
									<h4>Test</h4>
									4 vueltas x $5.000<br/>
									<h4>Corta</h4>
									10 vueltas x $7.000<br/>
									<h4>Normal</h4>
									15 vueltas x $10.000<br/>
									<h4>Desafio</h4>
									24 vueltas x $15.000<br/>
									</span>
								</div>
							</div>
						</article>
						...
						<article class="seccion_novedades">
							<div class="lateral_left img_left"
								style="
                                	background: #F5DA81 url(http://graph.facebook.com/962366610545862/picture?width=3000);
                                ...
                                <!--IMAGEN NOTICIA-->
                                <figure>
									<a target="_blank" href="https://www.facebook.com/Rallykartinplazaoeste/">
                                    	<img src="http://graph.facebook.com/962366610545862/picture?width=3000">
									</a>	
								</figure>
                                <!--FIN IMAGEN NOTICIA-->
							</div>
							<div class="lateral_right"><!--INDICACIONES MAPA-->
								...
								$tl = new timeline (
    							 '962366610545862', // username or id
								...
								<a target="_blank" href="https://www.facebook.com/Rallykartinplazaoeste/"><span class="btn_social">Visitar fanpage</span></a>
							</div>
						</article>
