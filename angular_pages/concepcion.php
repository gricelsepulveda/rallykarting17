...
<script src="js/galeria/concepcion.js" type="text/javascript"></script><!--GALERIA FACEBOOK JS-->
					<div class="contenedor_sede">
						...
						<article class="seccion_indicaciones">
							<div class="lateral_left img_left"
								style="
									background: #000000 url(img/concepcion/mapa.jpg);
								...
								"
							><!--MAPA-->
								<a target="_blank" href="https://goo.gl/maps/TKHffLZuoxA2">
									<figure>
										<img src="img/concepcion/mapa.jpg"><!--MAPA GOOGLE MAPS-->	
									</figure>
								</a>
							</div>
							<div class="lateral_right"><!--INDICACIONES MAPA-->
								<div class="indicaciones">
									...
									<span>Lunes a Viernes 11:00 a 22:00hrs. Sábado y Domingo 10:00 a 22:00hrs</span>
									<br/>
									<p>Dirección <i class="fa fa-angle-left"></i></p>
									<span>VIII Region, Concepción – Avda. talcahuano 9000, Estacionamientos del “Líder Híper”</span>
									<br/>
									<p>E-mail <i class="fa fa-angle-left"></i></p>
									<span>concepcion@rallykarting.cl</span>
									<br/>
									<p>Teléfonos <i class="fa fa-angle-left"></i></p>
									<a href="+56972465890‬"><span>+56972465890‬</span></a>
									<br/>
						...
						<article class="seccion_novedades">
							<div class="lateral_left img_left"
								style="
                                	background: #F5DA81 url(http://graph.facebook.com/1477398122565380/picture?width=3000);
                                ...
                                <!--IMAGEN NOTICIA-->
                                <figure>
									<a target="_blank" href="https://www.facebook.com/kartingconcepcion">
                                    <img src="http://graph.facebook.com/1477398122565380/picture?width=3000">
									</a>	
								</figure>
                                <!--FIN IMAGEN NOTICIA-->
							</div>
							<div class="lateral_right"><!--INDICACIONES MAPA-->
                                ...
                                <?php
								$tl = new timeline (
    							 '1477398122565380', // username or id
								...
								<a target="_blank" href="https://www.facebook.com/kartingconcepcion"><span class="btn_social">Visitar fanpage</span></a>
							</div>
						</article>
