...
<script src="js/galeria/antofagasta.js" type="text/javascript"></script><!--GALERIA FACEBOOK JS-->
					<div class="contenedor_sede">
						...
						<article class="seccion_indicaciones">
							<div class="lateral_left img_left"
								style="
									background: #000000 url(img/antofagasta/mapa.png);
								...
								"
							><!--MAPA-->
								<a target="_blank" href="https://goo.gl/maps/iDAXHngdzfA2">
									<figure>
										<img src="img/antofagasta/mapa.png"><!--MAPA GOOGLE MAPS-->	
									</figure>
								</a>
							</div>
							<div class="lateral_right"><!--INDICACIONES MAPA-->
								<div class="indicaciones">
									...
									<span>Lunes a Viernes 11:00 a 22:00hrs. Sábado y Domingo de 10:00 a 22:00hrs</span>
									<br/>
									<p>Dirección <i class="fa fa-angle-left"></i></p>
									<span>II Region, Antofagasta – Zenteno 21 Shopping Piso -2 (Estacionamientos -2)</span>
									<br/>
									<p>E-mail <i class="fa fa-angle-left"></i></p>
									<span>antofagasta@Rallykarting.cl</span>
									<br/>
									<p>Teléfonos <i class="fa fa-angle-left"></i></p>
									<a href="+56973540146"><span>+56973540146</span></a>
									<br/>
									<p>Valores <i class="fa fa-angle-left"></i></p>
									<span>
									<h4>Test</h4>
									6 Vueltas x $5.000<br/>
									<h4>Corta</h4>
									10 Vueltas x $7.000<br/>
									<h4>Normal</h4>
									18 Vueltas x $10.000<br/>
									<h4>Desafio</h4>
									28 Vueltas x $15.000
									</span>
								</div>
						...
						<article class="seccion_novedades">
							<div class="lateral_left img_left"
								style="
                                	background: #F5DA81 url(http://graph.facebook.com/267106520125537/picture?width=3000);
                                ...
                                <!--IMAGEN NOTICIA-->
                                <figure>
									<a target="_blank" href="https://www.facebook.com/kartingafta/">
                                    <img src="http://graph.facebook.com/267106520125537/picture?width=3000">
									</a>	
								</figure>
                                <!--FIN IMAGEN NOTICIA-->
							</div>
							<div class="lateral_right"><!--INDICACIONES MAPA-->
                                ...
                                <?php
								$tl = new timeline (
    							 '267106520125537', // username or id
								...
								<a target="_blank" href="https://www.facebook.com/kartingafta/"><span class="btn_social">Visitar fanpage</span></a>
							</div>
						</article>
