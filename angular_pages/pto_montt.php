...
<script src="js/galeria/ptomontt.js" type="text/javascript"></script><!--GALERIA FACEBOOK JS-->
					<div class="contenedor_sede">
						...
						<article class="seccion_indicaciones">
							<div class="lateral_left img_left"
								style="
									background: #000000 url(img/pto_montt/mapa.png);
								...
								"
							><!--MAPA-->
								<a target="_blank" href="https://goo.gl/maps/dPRJDiazwEm">
									<figure>
										<img src="img/pto_montt/mapa.png"><!--MAPA GOOGLE MAPS-->	
									</figure>
								</a>
							</div>
							<div class="lateral_right"><!--INDICACIONES MAPA-->
								<div class="indicaciones">
									...
									<span>Lunes a Sábado de 10:00 a 21:00hrs. Domingos y festivos de 11:00 a 21:00hrs</span>
									<br/>
									<p>Dirección <i class="fa fa-angle-left"></i></p>
									<span>Illapel 10 Mall paseo Costanera 4to piso.</span>
									<br/>
									<p>E-mail <i class="fa fa-angle-left"></i></p>
									<span>b@rallykarting.cl</span>
									<br/>
									<p>Teléfonos <i class="fa fa-angle-left"></i></p>
									<a href="+56978445446‬"><span>+56 9 7844 5446‬</span></a>
									<br/>
						...
						<article class="seccion_novedades">
							<div class="lateral_left img_left"
								style="
                                	background: #F5DA81 url(http://graph.facebook.com/431130450426355/picture?width=3000);
                                ...
                                <!--IMAGEN NOTICIA-->
                                <figure>
									<a target="_blank" href="https://www.facebook.com/rallykarting.puertomontt">
                                    <img src="http://graph.facebook.com/431130450426355/picture?width=3000">
									</a>	
								</figure>
                                <!--FIN IMAGEN NOTICIA-->
							</div>
							<div class="lateral_right"><!--INDICACIONES MAPA-->
                                ...
                                <?php
								$tl = new timeline (
    							 '431130450426355', // username or id
								...
								<a target="_blank" href="https://www.facebook.com/rallykarting.puertomontt"><span class="btn_social">Visitar fanpage</span></a>
							</div>
						</article>
